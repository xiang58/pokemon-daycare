...
<body>
  ...
  <div class="container">
    <form name="register" action="${pageContext.request.contextPath}/Pokemon" method="POST">
      Enter the pokedex:
